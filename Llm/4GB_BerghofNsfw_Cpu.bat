...
echo https://huggingface.co/mradermacher/Berghof-NSFW-7B-i1-GGUF
set HUGGING_FACE_REPO=mradermacher/Berghof-NSFW-7B-i1-GGUF
set HUGGING_FACE_DIR=
set HUGGING_FACE_FILE=Berghof-NSFW-7B.i1-Q4_K_M.gguf
